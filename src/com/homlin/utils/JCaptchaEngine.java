...
public class JCaptchaEngine extends ListImageCaptchaEngine {
	...
	public static final String CAPTCHA_INPUT_NAME = "jcaptcha";// 验证码输入表单名称
	public static final String CAPTCHA_IMAGE_URL = "/jcaptcha.jpeg";// 验证码图片URL
	...
	private static final String IMAGE_PATH = "./com/homlin/utils/captcha/";// 随机背景图片路径
