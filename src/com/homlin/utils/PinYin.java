...
public class PinYin {
	...
	public static String getFirstSpell(String cnStr) {
		String firstChar = cnStr.substring(0, 1);
		if (firstChar.equals("沣")) // ascii -7197
			return "f";
		else if (firstChar.equals("骊")) // ascii -6422
			return "l";
		else if (firstChar.equals("杈")) // ascii -5954
			return "c";
		// else if (cnStr.substring(0, 1).equals("阿")) //多音字吗？
		// return "e";
		else if (firstChar.equals("怡")) // ascii -7431
			return "y";
		else if (firstChar.equals("灞")) // ascii -6735
			return "b";
		else if (firstChar.equals("薰")) //
			return "x";
		else if (firstChar.equals("薏")) //
			return "y";
		else
			return getFullSpell(firstChar).substring(0, 1);
	}
