...
<div class="mini-toolbar" style="border-bottom:0;">
	...
	<input class="mini-combobox" id="searchby" data="[{id:'name',text:'角色名称'}]" value="name" style="width:80px;" />
...
<div class="mini-fit">
	<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;"
		idField="id" pageSize="20" ondrawcell="onDrawCell" multiSelect="true"
		url="datalist.do"
	>
		<div property="columns">
			<div type="indexcolumn" width="30"></div>
			<div type="checkcolumn"></div>
			<div field="name" width="200" headerAlign="center" allowSort="true">角色名称</div>
			<div field="description" width="100%" headerAlign="center">描述</div>
