...
<div class="mini-fit" style="padding:10px;">
  <form id="form1" onsubmit="return false">
    ...
    <input name="position" class="mini-hidden" value="middle" />
    <div style="padding-left:11px;padding-bottom:5px;">
      <table style="table-layout:fixed;">
        <tr>
          <td style="width:80px;">名称：</td>
          <td><input name="title" id="title" class="mini-textbox" required="true" width="300" /><label><input type="checkbox" id="continue">连续添加</label></td>
        </tr>
        <tr>
          <td>预设：</td>
        ...
        <tr>
          <td>链接：</td>
          <td><input name="url" id="url" class="mini-textbox" required="true" width="300" /></td>
        </tr>
        <tr>
          <td></td>
          <td><input type="checkbox" name="isBlankTarget" class="mini-checkbox" trueValue="1" falseValue="0" text="新窗口打开"></td>
        </tr>
        <tr>
          <td>排序：</td>
          <td><input name="displayorder" class="mini-spinner" minValue="0" maxValue="999999999" value="0" required="true" /></td>
        </tr>
        <tr>
          <td>状态：</td>
          <td><input type="checkbox" name="isShow" class="mini-checkbox" trueValue="1" falseValue="0" text="启用"></td>
        </tr>
      </table>
    </div>
  </form>
