...
<div class="mini-toolbar" style="border-bottom:0;">
	...
	<input class="mini-combobox" id="searchby" data="[{id:'name',text:'名称'}]" value="name" style="width:80px;" />
...
<div class="mini-fit">
	...
	>
		<div property="columns">
			...
			<div field="displayorder" width="70">排序</div>
			...
			<div field="specificationValues" width="100%"></div>
		</div>
	</div>
</div>
<script type="text/javascript">
	...
	function edit() {
		...
		if (row) {
			miniExt.win.open({
				url: "specification/edit.htm?id="+row.id,
				title: "编辑规格",
				width: 700,
				height: 450
			}).callback(function(){
