...
<div class="mini-fit" style="padding:10px 20px 10px 10px;">
	<form id="form1">
		<div class="line"><span>配送方式：</span><input type="text" name="name" id="name"/><label><input type="checkbox" id="continue">连续添加</label></div>
		<div class="line"><span>备注：</span><input type="text" name="remark"></div>
		<div class="line"><span>排序：</span><input type="text" class="input" name="displayorder"><label><input type="checkbox" name="enabled" value="1">启用</label></div>
		  <div style="color:gray;">除指定地区外，其余地区的运费采用“默认运费”</div>
		  <div class="main">
			<div class="default"><b>默认运费：</b>
			  首重
			  <input type="text" class="input" name="firstWeight" id="firstWeight" maxlength="18" autocomplete="off" value="1000" />
			  克，
			  <input type="text" class="input" name="firstPrice" id="firstPrice" maxlength="18" autocomplete="off" />
			  元， 续重每
			  <input type="text" class="input" name="continueWeight" id="continueWeight" maxlength="18" autocomplete="off" value="1000" />
			  克， 增加运费
			  <input type="text" class="input" name="continuePrice" id="continuePrice" maxlength="18" autocomplete="off" />
			  元
			</div>
			<div id="J_details" style="display:none;">
			...
			<div style="padding:5px 3px;"><span class="add">为指定地区设置运费</span>
			  <input type="hidden" id="J_all_areaCode" />
			  <input type="hidden" id="J_all_areaName" />
			</div>
		  </div>
	</form>
