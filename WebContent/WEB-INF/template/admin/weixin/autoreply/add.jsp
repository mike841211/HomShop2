  ...
  <form id="form1" onsubmit="return false">
    ...
    <div style="padding-left:11px;padding-bottom:5px;">
      <table style="table-layout:fixed;width:100%;">
        ...
        <tr>
          <td>关键字：</td>
		  <td><input name="keyword" class="mini-textbox" style="width:437px;" required="true" requiredErrorText="关键字不能为空" /></td>
		</tr>
        <tr>
          <td>关键字匹配：</td>
		  <td><div name="matching" class="mini-radiobuttonlist" textField="text" valueField="id" value="complete" data="[{'text':'完全匹配','id':'complete'},{'text':'模糊匹配','id':'partial'}]" ></div></td>
		</tr>
        <tr>
          <td>类别：</td>
          <td><select name="replyType" id="replyType" class="mini-ComboBox"  style="width:150px" >
        ...
        <tr>
          <td>摘要：</td>
		  <td><input name="summary" class="mini-textarea" style="width:437px;height:70px;" value="" /></td>
		</tr>
        </tr>
        <tr>
		  <td>设置：</td>
