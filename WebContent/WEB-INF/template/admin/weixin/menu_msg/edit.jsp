    ...
    <div style="padding-left:11px;padding-bottom:5px;">
      <table style="table-layout:fixed;width:100%;">
        ...
        <tr>
		  ...
		  valueField="id" textField="name" url="../menu/getTreeData.do" value="${model.tbWxMenu.id}" text="${model.tbWxMenu.name}" /></td>
        </tr>
        <tr>
          <td>封面：</td>
        ...
        <tr>
          <td>摘要：</td>
		  <td><input name="summary" class="mini-textarea" style="width:437px;height:120px;" value="${model.summary}" /></td>
		</tr>
        </tr>
        <tr>
		  <td>设置：</td>
