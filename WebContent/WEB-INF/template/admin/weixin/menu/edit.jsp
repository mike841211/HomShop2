...
<div class="mini-fit" style="padding:10px;">
  <form id="form1" onsubmit="return false">
    ...
    <input name="createDate" id="createDate" class="mini-hidden" value="${model.createDate}" />
      ...
      <table style="table-layout:fixed;">
        ...
        <tr>
          ...
          <td><input name="tbWxMenu.id" id="parentId" class="mini-treeselect"
			  ...
			  value="${model.tbWxMenu.id}" text="${model.tbWxMenu.name}"
			  url="getTreeData.do"
			  />
          </td>
        </tr>
        ...
        <tr>
          <td>菜单类型：</td>
          <td>
		   <select name="menuType" id="menuType" class="mini-ComboBox"><option value=""></option><option value="click">消息</option><option value="view">链接</option></select>
		</td>
        </tr>
        <tr>
          <td>消息功能：</td>
        ...
        <tr>
          <td>链接地址：</td>
          <td><input name="url" id="url" class="mini-textbox" style="width:350px;" value="${model.url}" /></td>
        </tr>
        <tr>
          <td>预设链接：</td>
...
<script type="text/javascript">
	...
	// 选中
	mini.get("menuType").setValue("${model.menuType}");
	mini.get("messageType").setValue("${model.messageType}");
	mini.get("functionKey").setValue("${model.functionKey}");
</script>
</body>
</html>
