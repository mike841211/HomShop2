...
<div class="mini-fit">
	...
	<input class="mini-hidden" name="sampleImage" id="sampleImage" />
	<input class="mini-hidden" name="imageStore" id="imageStore" />
	<div id="tabs1" class="mini-tabs" activeIndex="0" style="height:100%;">
		<div name="first" title="基本信息">
		  <table style="table-layout:fixed;">
		    <tr>
		      <td>商品名称：</td>
		      <td colspan="3"><input name="name" id="name" class="mini-textbox" required="true" style="width:360px;" />
				  <label><input type="checkbox" id="continue">连续添加</label>
			  </td>
		    </tr>
			<tr>
			  <td>商品广告词：</td>
			  <td colspan="3"><input name="slogan" id="slogan" class="mini-textbox" style="width:433px;" /></td>
			</tr>
		    <tr>
		      <td style="width:80px;">系统编号：</td>
		      <td style="width:220px;"><input name="syssn" id="syssn" class="mini-textbox" value="" emptyText="自动分配" vtype="int" readonly /></td>
		      <td style="width:80px;">商品货号：</td>
		      <td><input name="sn" id="sn" class="mini-textbox" /></td>
		    </tr>
		    <tr>
		      <td>单位：</td>
		      <td><input name="unit" id="unit" class="mini-textbox" /></td>
		      <td>条码：</td>
		      <td><input name="barcode" id="barcode" class="mini-textbox" /></td>
		    </tr>
		    <tr>
		      <td>分类：</td>
			  ...
			  <td><input name="tbShopBrand.id" id="brand" class="mini-combobox"
					...
					valueField="value" textField="text" value=""
			...
			<tr>
			  <td>标签：</td>
			  <td colspan="3">
			  	<input class="mini-checkbox" trueValue="1" falseValue="0" name="isNew" id="isNew" text="新品" value="0" >
			  	<input class="mini-checkbox" trueValue="1" falseValue="0" name="isHot" id="isHot" text="热销" value="0" >
			  	<input class="mini-checkbox" trueValue="1" falseValue="0" name="isPromotion" id="isPromotion" text="促销" value="0" >
			  	<input class="mini-checkbox" trueValue="1" falseValue="0" name="isRecomend" id="isRecomend" text="推荐" value="0" >
			  </td>
			</tr>
			<tr>
			  <td>设置：</td>
			  <td colspan="3">
			  	<input class="mini-checkbox" trueValue="1" falseValue="0" name="isSale" id="isSale" text="上架" value="1" checked="true" >
			  	<input class="mini-checkbox" trueValue="1" falseValue="0" name="isFreeShipping" id="isFreeShipping" text="免运费" value="0" >
			  </td>
			</tr>
			<tr>
			  <td>搜索关键词：</td>
			  <td colspan="3"><input name="keyword" id="keyword" class="mini-textbox" style="width:433px;" /></td>
			</tr>
			<tr>
			  <td>页面关键词：</td>
			  <td colspan="3"><input name="metaKeyword" id="metaKeyword" class="mini-textbox" style="width:433px;" /></td>
			</tr>
			<tr>
			  <td>页面描述：</td>
			  <td colspan="3"><input name="metaDescription" id="metaDescription" class="mini-textbox" style="width:433px;" /></td>
			</tr>
		  </table>
		...
		<div title="商品描述">
		  <textarea name="introduction" style="width:99%;height:470px;"></textarea>
		</div>
		...
		$.ajax({
			...
			success: function (json) {
				if (json.status=="success"){
					top.miniExt.showMsg("保存成功，继续添加商品SKU");
