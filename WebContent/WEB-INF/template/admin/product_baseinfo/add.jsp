  ...
  <form id="form1" onsubmit="return false">
      ...
      <table style="table-layout:fixed;">
        <tr>
          ...
          <td><input name="title" class="mini-textbox" style="width:500px" required="true" requiredErrorText="品牌名称不能为空" />
		  <label><input type="checkbox" id="continue">连续添加</label></td>
        </tr>
        <tr>
          <td>标识：</td>
          <td><input name="sign" id="sign" class="mini-textbox" style="width:500px" /></td>
        </tr>
        <tr>
          <td>内容：</td>
          <td><textarea name="content" style="width:100%;height:430px;"></textarea></td>
        </tr>
      </table>
  </form>
</div>
