    ...
    <div style="padding-left:11px;padding-bottom:5px;">
      <table style="table-layout:fixed;width:100%;">
        ...
        <tr>
		  ...
		  valueField="id" textField="name" url="../article_category/getArticleCatagoryTreeData.do" /></td>
        </tr>
        <tr>
          <td>作者：</td>
          <td><input name="author" class="mini-textbox" /></td>
        </tr>
        <tr>
          <td>封面：</td>
          <td><input name="coverimg" id="coverimg" class="mini-textbox" width="437" />
        ...
        <tr>
          <td>摘要：</td>
		  <td><input name="summary" class="mini-textarea" style="width:437px;" value="" /></td>
		</tr>
        </tr>
        <tr>
		  <td>设置：</td>
		...
		<tr>
		  <td>页面关键词：</td>
		  <td><input name="metaKeyword" id="metaKeyword" class="mini-textbox" style="width:437px;" /></td>
		</tr>
		<tr>
		  <td>页面描述：</td>
		  <td><input name="metaDescription" id="metaDescription" class="mini-textbox" style="width:437px;" value="" /></td>
		</tr>
      </table>
    </div>
  </form>
