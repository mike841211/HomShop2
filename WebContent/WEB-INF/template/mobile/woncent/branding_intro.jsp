...
<c:set var="slides" value="${CacheUtil.getAdverts('branding_intro')}"/>
...
<style type="text/css">
	.swiper-container {background:#eb5520;}
...
<section class="fixed-img">
	<img src="${base}/resources/mobile/woncent/images/about_3.png" id="J_title" />
</section>
<c:if test="${fn:length(slides)>0}">
<!-- swiper begin -->
