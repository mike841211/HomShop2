...
(function($) {
    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {
        ...
        for (var page = startPoint; page <= endPoint; page++) {
            ...
            page == pagenumber
			 ? currentButton.addClass('active').html('<input type="text" value="'+pagenumber+'" title="跳转到页码，共'+pagecount+'页" >')
				.keyup(function(e) {
					var _value = this.firstChild.value.replace(/[^\d]/,'');
					if (_value>pagecount){_value=pagecount;}
					this.firstChild.value = _value;

					if (e.keyCode==13){//ENTER
						if(_value==pagenumber){return;}
						buttonClickCallback(_value);
					}
				})
        ...
        //$pager.append(' 到第 <input type="text" value="'+pagenumber+'"> 页');
        //$pager.append(' <button>跳转</button>');
        ////$pager.append('</li>');
