...
//document.write('<script src="' + bootPATH + 'jquery-migrate-1.1.1.min.js" type="text/javascript"></sc' + 'ript>');
}
...
document.write('<script src="' + bootPATH + 'miniui-ext.js" type="text/javascript" ></sc' + 'ript>');
document.write('<link href="' + bootPATH + 'mini-ext.css" rel="stylesheet" type="text/css" />');
